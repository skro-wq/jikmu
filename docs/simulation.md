...
| 4. 외부 사건 발생 | 권리 승계 이후 사건이 일어나 회사 이익이 충격배율만큼 달라진다 | 없음 |
...
이 본문과 단서의 긴장에서 두 모델이 갈립니다. 다만 갈리는 지점을 정확히 적어 둡니다.
지급액이 판례상 공헌도 범위에 견주어 충분한지에 대한 **판단 자체는 두 모델이 거의 같습니다**
(지급이 이익의 10%에 못 미치는 국면에서 둘 다 61.9%가 불충분하다고 보고, 20%를 넘는
국면에서는 둘 다 0%). 차이는 그 판단을 조문의 어느 대목에 거는가입니다. 형식 수준 3에서
단서를 끌어들인 비율이 GPT-5는 9.4%, Claude는 65.6%입니다.

`analysis/reproduce_tables.py`가 출력하는 '제6항 단서 언급률'이 이 값입니다. 이전 판본은
추론 기록에서 '추정이 성립한다'는 판단을 규칙으로 분류했는데, 그 규칙이 GPT-5의 표현에
맞춰져 있어 Claude 64건 가운데 60건을 놓쳤습니다. 조문의 어디까지 짚었는지를 재는 지표로
바꾸었고, 이 지표는 법적 결론을 분류하지 않습니다.
